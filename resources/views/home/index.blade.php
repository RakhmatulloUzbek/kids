...
<img src="{{asset('assets')}}/images/service1.jpg" alt title>
...
<a href="#"><i class="fa fa-link"></i></a>
                ...
                <div class="dt-sc-one-fourth column">
                    <div class="dt-sc-ico-content type1">
                        <div class="icon">
<span class="icon-outer">
<img src="{{asset('assets')}}/images/service2.jpg" alt title>
<span class="infolayer">
<a href="#"><i class="fa fa-link"></i></a>
</span>
</span>
                ...
                <div class="dt-sc-one-fourth column">
                    <div class="dt-sc-ico-content type1">
                        <div class="icon">
<span class="icon-outer">
<img src="{{asset('assets')}}/images/service3.jpg" alt title>
<span class="infolayer">
<a href="#"><i class="fa fa-link"></i></a>
</span>
</span>
                ...
                <div class="dt-sc-one-fourth column">
                    <div class="dt-sc-ico-content type1">
                        <div class="icon">
<span class="icon-outer">
<img src="{{asset('assets')}}/images/service4.jpg" alt title>
<span class="infolayer">
<a href="#"><i class="fa fa-link"></i></a>
</span>
</span>
                ...
                <div class="container">
                    ...
                    <div class="dt-sc-one-half column">
                        ...
                        <div class="add-slider-wrapper">
                            <ul class="add-slider">
                                <li> <img src="{{asset('assets')}}/images/add1.jpg" alt title> </li>
                                <li> <img src="{{asset('assets')}}/images/add2.jpg" alt title> </li>
                                <li> <img src="{{asset('assets')}}/images/add1.jpg" alt title> </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="front-portfolio-container">
                        ...
                        <div class="front-portfolio">
                            <div class="portfolio-outer">
                                <div class="portfolio-thumb">
                                    <img src="{{asset('assets')}}/images/image1.jpg" alt title>
                                    <div class="image-overlay">
                                        ...
                                        <a href="{{asset('assets')}}/images/image1.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-content portfolio-content2">
                        <div class="front-portfolio">
                            <div class="portfolio-outer">
                                <div class="portfolio-thumb">
                                    <img src="{{asset('assets')}}/images/image2.jpg" alt title>
                                    <div class="image-overlay">
                                        <h5><a href="portfolio-detail.html">Gifts at Large</a></h5>
                                        <a href="portfolio-detail.html" class="link"><span class="fa fa-link"></span></a>
                                        <a href="{{asset('assets')}}/images/image2.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-content portfolio-content3">
                        <div class="front-portfolio">
                            <div class="portfolio-outer">
                                <div class="portfolio-thumb">
                                    <img src="{{asset('assets')}}/images/image3.jpg" alt title>
                                    <div class="image-overlay">
                                        <h5><a href="portfolio-detail.html">Gifts at Large</a></h5>
                                        <a href="portfolio-detail.html" class="link"><span class="fa fa-link"></span></a>
                                        <a href="{{asset('assets')}}/images/image3.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-content portfolio-content4">
                        <div class="front-portfolio">
                            <div class="portfolio-outer">
                                <div class="portfolio-thumb">
                                    <img src="{{asset('assets')}}/images/image4.jpg" alt title>
                                    <div class="image-overlay">
                                        <h5><a href="portfolio-detail.html">Gifts at Large</a></h5>
                                        <a href="portfolio-detail.html" class="link"><span class="fa fa-link"></span></a>
                                        <a href="{{asset('assets')}}/images/image4.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-content portfolio-content5">
                        <div class="front-portfolio">
                            <div class="portfolio-outer">
                                <div class="portfolio-thumb">
                                    <img src="{{asset('assets')}}/images/image5.jpg" alt title>
                                    <div class="image-overlay">
                                        <h5><a href="portfolio-detail.html">Gifts at Large</a></h5>
                                        <a href="portfolio-detail.html" class="link"><span class="fa fa-link"></span></a>
                                        <a href="{{asset('assets')}}/images/image5.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-content portfolio-content6">
                        <div class="front-portfolio">
                            <div class="portfolio-outer">
                                <div class="portfolio-thumb">
                                    <img src="{{asset('assets')}}/images/image6.jpg" alt title>
                                    <div class="image-overlay">
                                        <h5><a href="portfolio-detail.html">Gifts at Large</a></h5>
                                        <a href="portfolio-detail.html" class="link"><span class="fa fa-link"></span></a>
                                        <a href="{{asset('assets')}}/images/image6.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-content portfolio-content7">
                        <div class="front-portfolio">
                            <div class="portfolio-outer">
                                <div class="portfolio-thumb">
                                    <img src="{{asset('assets')}}/images/image7.jpg" alt title>
                                    <div class="image-overlay">
                                        <h5><a href="portfolio-detail.html">Gifts at Large</a></h5>
                                        <a href="portfolio-detail.html" class="link"><span class="fa fa-link"></span></a>
                                        <a href="{{asset('assets')}}/images/image7.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul class="products">
                        <li class="dt-sc-one-fourth column first">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{asset('assets')}}/images/product1.jpg" alt title>
                                </a>
                        ...
                        <li class="dt-sc-one-fourth column">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{asset('assets')}}/images/product2.jpg" alt title>
                                </a>
                                <div class="image-overlay">
                                    <div class="product-button">
                                        <a href="#" class="add-cart-btn"> Add to cart </a>
                        ...
                        <li class="dt-sc-one-fourth column">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{asset('assets')}}/images/product3.jpg" alt title>
                                </a>
                                <span class="sale"> Sale! </span>
                                <div class="image-overlay">
                                    <div class="product-button">
                        ...
                        <li class="dt-sc-one-fourth column">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{asset('assets')}}/images/product4.jpg" alt title>
                                </a>
                                <div class="image-overlay">
                                    <div class="product-button">
                                        <a href="#" class="add-cart-btn"> Add to cart </a>
